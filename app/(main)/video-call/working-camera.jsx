...
export default function WorkingCamera({ callId, userId, userName }) {
  ...
  useEffect(() => {
    ...
    const initializeCamera = async () => {
      try {
        ...
        // Request camera and microphone permissions with optimal settings
        ...
        // Set up local video with proper error handling
        if (localVideoRef.current) {
          localVideoRef.current.srcObject = stream;
          localVideoRef.current.muted = true; // Always mute local to prevent feedback
          ...
          localVideoRef.current.onerror = (e) => {
            ...
            toast.error('Failed to display local video');
          };
        ...
        // Set up remote video (simulate peer for now)
        if (remoteVideoRef.current) {
          // For demo, create a duplicate stream
          const remoteStream = stream.clone();
          remoteVideoRef.current.srcObject = remoteStream;
          remoteVideoRef.current.muted = false; // Allow audio for remote
          ...
          const playRemoteVideo = async () => {
            try {
              ...
              // Try autoplay with muted first, then unmute

...
export default function GuaranteedVideo({ callId, userId, userName }) {
  ...
  useEffect(() => {
    ...
    const initializeCamera = async () => {
      try {
        ...
        // Request camera and microphone permissions with guaranteed working settings
        ...
        // Set up local video with aggressive display strategy
        ...
        // Set up remote video (simulate peer with same stream for demo)

...
export default function LiveVideo({ callId, userId, userName }) {
      ...
      try {
        ...
        if (localVideoRef.current) {
          ...
          localVideoRef.current.play().catch(error => {
            ...
            toast.error('Failed to start local video');
          });
        }
        
        // Set up remote video (for demo, we'll use the same stream)
        // In production, this would connect to another peer

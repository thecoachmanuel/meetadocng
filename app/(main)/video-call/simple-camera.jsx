...
export default function SimpleCamera({ callId, userId, userName }) {
  ...
  useEffect(() => {
    ...
    const initializeCamera = async () => {
      try {
        ...
        // Set up remote video (simulate the other person's view)
        if (remoteVideoRef.current) {
          // For demo, we'll use the same stream but you could connect to another peer

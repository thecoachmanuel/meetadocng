		...
		<div className="container mx-auto max-w-4xl px-4 py-12 space-y-10">
				...
				<CardContent className="p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-8">
					<div className="space-y-4 flex-1">
						...
						<h1 className="text-3xl md:text-4xl font-semibold text-white leading-tight">
							Healthcare that feels a little more human
						</h1>
						<p className="text-sm md:text-base text-muted-foreground max-w-xl">
							MeetADoc helps you talk to licensed doctors from wherever you are –
							without traffic, crowded waiting rooms, or confusing apps.
						</p>
			...
			<section className="grid gap-5 md:grid-cols-3">
				<Card className="bg-muted/15 border-emerald-900/25">
					<CardHeader className="flex flex-row items-center gap-3 pb-2">
						...
						<CardTitle className="text-sm text-white">For patients</CardTitle>
					</CardHeader>
					<CardContent className="text-xs md:text-sm text-muted-foreground space-y-1.5">
				...
				<Card className="bg-muted/15 border-emerald-900/25">
					<CardHeader className="flex flex-row items-center gap-3 pb-2">
						...
						<CardTitle className="text-sm text-white">For doctors</CardTitle>
					</CardHeader>
					<CardContent className="text-xs md:text-sm text-muted-foreground space-y-1.5">
				...
				<Card className="bg-muted/15 border-emerald-900/25">
					<CardHeader className="flex flex-row items-center gap-3 pb-2">
						...
						<CardTitle className="text-sm text-white">Our promise</CardTitle>
					</CardHeader>
					<CardContent className="text-xs md:text-sm text-muted-foreground space-y-1.5">
			...
			<section className="max-w-3xl mx-auto">
				<Card className="bg-muted/10 border-emerald-900/25">
					<CardContent className="p-5 md:p-6 space-y-3 text-xs md:text-sm text-muted-foreground">
						<p>
